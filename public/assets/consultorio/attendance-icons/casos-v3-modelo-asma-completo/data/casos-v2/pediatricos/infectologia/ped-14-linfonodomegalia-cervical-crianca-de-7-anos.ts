...
export const casoPed014LinfonodomegaliaCervicalCriancaDe7Anos: CasoPediatricoOSCEV2 = {
  id: "ped-14",
  codigo: "PED-14",
  versao: "3.0.0",
  ...
  tema: "Linfonodos",
  subtema: "Linfonodomegalia cervical reativa",
  nivel: "iniciante",
  ...
  diagnostico: {
    principal: "Linfonodomegalia cervical reativa",
    categoria: "Linfonodos",
    hipotesesOriginais: [
      {
    ...
    diferenciais: ["Linfoma", "Tuberculose"]
},
