...
export const casosOSCE: Caso[] = [
  ...
  // ====== CASO 61: CARDIOMEGALIA EM INVESTIGAÇÃO ======
  {
    id: "61",
  ...
  // ====== CASO 62: PNEUMOTÓRAX ESPONTÂNEO ======
  {
    id: "62",
  ...
  // ====== CASO 63: ATELECTASIA PÓS-OPERATÓRIA ======
  {
    id: "63",
  ...
  // ====== CASO 64: BRONQUIOLITE VIRAL AGUDA (PEDIÁTRICO) ======
  {
    id: "64",
    titulo: "Bronquiolite viral aguda",
    sistema: "Pediatria / Respiratório",
    tema: "Doença das pequenas vias aéreas",
    nivel: "iniciante",
    tipo_estacao: "integrada",
    tempo_osce_minutos: 12,
    objetivo_pedagogico: "Reconhecer bronquiolite viral aguda em lactente e estabelecer manejo de suporte com oxigênio e hidratação conforme gravidade",
    dados_visiveis_ao_estudante: {
      nome_paciente: "Miguel Souza",
      idade: 0.67,
      sexo: "Masculino",
      queixa_principal: "Bebê com tosse, chiado e dificuldade para respirar",
      historia_breve: "Lactente 8 meses com coriza há 3 dias, tosse há 2-3 dias, chiado desde ontem. Piora nas últimas horas. Dificuldade para mamar.",
    },
    dados_ocultos_do_sistema: {
      diagnostico_principal: "Bronquiolite viral aguda",
      diagnosticos_diferenciais: ["Pneumonia", "Asma/sibilância recorrente", "Aspiração de corpo estranho", "Coqueluche", "Insuficiência cardíaca congênita"],
      sindromes_associadas: ["Doença das pequenas vias aéreas", "Insuficiência respiratória leve a moderada"],
    },
    descricaoBreve: "Lactente taquipneico com sibilância difusa bilateral, retrações intercostais, dificuldade para alimentação",
    categoria: "Bronquiolite",
    paciente: {
      id: "pac-064",
      nome: "Miguel Souza",
      idade: 0.67,
      sexo: "M",
      queixaPrincipal: "Tosse, coriza, chiado e dificuldade respiratória",
      historicoDoenca: "Coriza há 3 dias, tosse há 2-3 dias, chiado desde ontem. Piora da respiração nas últimas horas. Contato com irmão gripado.",
      antecedentes: ["Nascido a termo, parto normal", "Vacinação em dia", "Amamentação exclusiva", "Sem cardiopatia conhecida", "Primeiro episódio de chiado"],
      alergias: [],
      medicamentos_em_uso: [],
    },
    respostas_do_paciente: {
      inicial: "Doutor(a), trouxe o Miguel porque começou com coriza e tosse há uns três dias. Desde ontem eu percebi que ele está chiando e fazendo mais esforço para respirar.",
      coriza_duracao: "Começou faz uns 3 dias, de repente.",
      tosse_tipo: "É tosse seca. Não sai escarro, mas ele tosse bastante, principalmente à noite.",
      chiado_inicio: "Só apareceu ontem. Eu reconheço porque meu outro filho tem asma.",
      respiracao_esforco: "Sim, ele está respirando com mais esforço. Vejo as costinhas dele se mexendo para respirar.",
      alimentacao_impacto: "Ele está mamando bem menos por causa disso. Fica cansado de respirar.",
      febre: "Tem uns dias que ele tá com febre baixa, mas ontem e hoje a temperatura está mais normal.",
      contato_doente: "Meu filho mais velho tava gripado semana passada. Acho que o Miguel pegou disso.",
      cianose: "Não, ele está rosadinho, sem aquele tom azulado não.",
      apneia: "Não, ele não paralisa a respiração não. Mas fica acelerado.",
    },
    respostaPaciente: {
      inicial: "Tosse, coriza e chiado, dificuldade para respirar",
      coriza: "Há 3 dias",
      tosse: "Seca, pior à noite",
      chiado: "Desde ontem",
      respiracao: "Com esforço, taquipneia",
      alimentacao: "Mamando menos",
      febre: "Febre baixa, agora melhor",
      contato: "Irmão gripado",
    },
    sinais_vitais: {
      corretos: {
        pressaoArterial: "90/60 mmHg",
        frequenciaCardiaca: 148,
        frequenciaRespiratoria: 52,
        temperatura: 37.8,
        saturacaoOxigenio: 93,
      },
    },
    ...
    exame_fisico: {
      correto: {
        inspecao: "Taquipneico, retrações intercostais, eupneico em repouso",
        palpacao: "Tórax simétrico",
        ausculta: "Sibilância difusa bilateral, crepitações finas",
        percussao: "Hipersonoridade",
        observacoes: "Padrão clássico de bronquiolite",
        regiao: "Pulmões bilateralmente",
        achados_positivos: ["Sibilância bilateral", "Retrações", "Taquipneia"],
        achados_negativos: ["Consolidação", "Macicez"],
      },
    },
    exameFisicoCorreto: {
      inspecao: "Taquipneico, retrações",
      palpacao: "Tórax simétrico",
      ausculta: "Sibilância difusa",
      percussao: "Hipersonoro",
      observacoes: "Bronquiolite clássica",
    },
    exame_fisico_interativo: {
      respiratorio: {
        inspecao_torax: "Taquipneia 52, retrações",
        expansibilidade: "Normal bilateralmente",
        ausculta_pulmonar: "Sibilância difusa, crepitações",
      },
    },
    exames_complementares_disponiveis: [
      {
        nome: "Radiografia de Tórax PA",
        descricao: "Padrão de pequenas vias",
        resultado: "Hiperinsuflação bilateral, espessamento peribrônquico",
        valor_referencia: "Normal ou achados mínimos",
        interpretacao: "Bronquiolite com hiperinsuflação",
      },
      {
        nome: "Teste VSR",
        descricao: "Antígeno respiratório",
        resultado: "Vírus Sincicial Respiratório positivo",
        valor_referencia: "Negativo",
        interpretacao: "Bronquiolite por VSR",
      },
    ],
    hipoteses_diagnosticas_esperadas: [
      {
        diagnostico: "Bronquiolite viral",
        probabilidade: 90,
        criterios_minimos: ["Lactente", "Sibilância bilateral", "Taquipneia"],
      },
    ],
    diagnosticos_diferenciais: [
      {
        diagnostico: "Pneumonia",
        criterios_exclusao: ["Sem consolidação"],
        achados_que_descartam: ["Sem opacidade focal"],
      },
    ],
    examesIndicados: ["RX Tórax", "Teste VSR"],
    conduta_esperada: {
      imediata: ["Oxigenioterapia se SpO2 <90%", "Hidratação"],
      curto_prazo: ["Monitorização", "Suporte respiratório"],
      longo_prazo: ["Seguimento pediátrico"],
      encaminhamentos: ["Pediatria"],
    },
    condutaCorreta: "Oxigenioterapia se necessário, hidratação, monitorização, suporte respiratório",
    criterios_de_gravidade: [
      {
        severidade: "moderada",
        sinais: ["SpO2 94%", "Retrações", "Taquipneia 52"],
        descricao: "Bronquiolite com hipoxemia leve e desconforto",
        recomendacao: "Oxigenioterapia, hidratação, monitorização",
      },
    ],
    erros_criticos: [
      {
        erro: "Não oferecer oxigenioterapia",
        descricao: "SpO2 <94% requer suporte",
        penalidade: 2,
        evitavel: true,
      },
    ],
    checklist_osce: [
      { item: "Investigou contatos doentes", realizado: false, critico: true },
      { item: "Realizou ausculta pulmonar", realizado: false, critico: true },
      { item: "Mediu frequência respiratória", realizado: false, critico: true },
      { item: "Verificou saturação", realizado: false, critico: true },
      { item: "Indicou oxigenioterapia", realizado: false, critico: true },
    ],
    rubrica_correcao: [
      { criterio: "Exame Físico", peso: 25, descricao: "Ausculta, respiração", pontuacao_maxima: 25 },
      { criterio: "Diagnóstico", peso: 30, descricao: "Reconhecimento de bronquiolite", pontuacao_maxima: 30 },
      { criterio: "Conduta", peso: 25, descricao: "Oxigenioterapia, hidratação", pontuacao_maxima: 25 },
    ],
    modelo_soap: {
      subjetivo: { secao: "S", componentes_obrigatorios: ["Tosse", "Chiado", "Contato doente"] },
      objetivo: { secao: "O", componentes_obrigatorios: ["Sibilância", "Taquipneia", "SpO2 94%"] },
      avaliacao: { secao: "A", componentes_obrigatorios: ["Bronquiolite"] },
      plano: { secao: "P", componentes_obrigatorios: ["Oxigenioterapia", "Hidratação"] },
    },
    feedback_modelo: {
      acertos_esperados: ["Ausculta", "Frequência respiratória", "Oxigenioterapia", "Hidratação"],
      erros_comuns: ["Não auscultar", "Ignorar taquipneia"],
      orientacoes_pedagogicas: ["Bronquiolite: lactente + sibilância + taquipneia + RX com hiperinsuflação"],
    },
    checklist_oculto_examinador: {
      oQueProfessorQuer: "Reconhecer bronquiolite e oferecer suporte respiratório",
      comunicacao: ["tranquilizou responsável"],
      anamnese: ["investigou contatos"],
      exame_fisico: ["ausculta pulmonar", "frequência respiratória"],
      exames_complementares: ["ofereceu oxigenioterapia"],
      raciocinio: ["reconheceu bronquiolite"],
      conduta: ["oxigenioterapia", "hidratação"],
      soap: ["documentou sibilância"],
    },
    temaOSCE: "Bronquiolite",
    subtopicosOSCE: ["Lactente", "Sibilância", "Taquipneia", "RX hiperinsuflação", "Oxigenioterapia"],
    diagnosticoCorreto: "Bronquiolite",
  },
