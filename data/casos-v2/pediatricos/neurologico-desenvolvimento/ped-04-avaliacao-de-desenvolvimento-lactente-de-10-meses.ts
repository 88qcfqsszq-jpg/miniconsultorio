...
export const casoPed004AvaliacaoDeDesenvolvimentoLactenteDe10: CasoPediatricoOSCEV2 = {
  id: "ped-04",
  codigo: "PED-04",
  versao: "3.0.0",
  ...
  subtema: "Desenvolvimento normal para idade",
  nivel: "iniciante",
  ...
  diagnostico: {
    principal: "Desenvolvimento normal para idade",
    ...
    diferenciais: ["Atraso no desenvolvimento"]
},
  ...
  feedbackDetalhado: {
    ...
    dominios: [
      ...
      {
        nome: "Marcos do desenvolvimento e sinais de alarme",
        pontos: 3,
        criterios: [
