...
export const caso018InfartoAgudoDoMiocardioSemSupra: CasoOSCEV2 = {
...
diagnosticoCorreto: "Infarto Agudo do Miocárdio sem Supra de ST",
  ...
  exames_laboratoriais_detalhados: {
    ...
    marcadoresCardiacos: {
      solicitadoPor: ["troponina seriada", "ckmb", "bnp"],
      disponivel: true,
      prioridade: "obrigatorio",
      interpretacao: "Troponina elevada sem supra de ST, compatível com IAM sem supra.",
      valores: {
        troponinaI0h: "0,18 ng/mL",
        troponinaI3h: "1,4 ng/mL",
        ckmb: "18 ng/mL",
        bnp: "110 pg/mL",
      },
    },
