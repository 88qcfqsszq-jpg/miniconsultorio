...
// import { casosPediatricos } from "./casos-pediatricos"; // Arquivo legado, não está sendo usado
...
const LABS_OVERRIDES_BY_ID: Record<string, FonteExamesLaboratoriais> = {
  "1": {
    hemograma: {
    ...
    marcadores_cardiacos: {
      ...
      dados: { troponina: "2,8 ng/mL", ckmb: "32 ng/mL", bnp: "96 pg/mL" },
    },
  },
  "2": {
    hemograma: {
    ...
    marcadores_inflamatorios: {
      ...
      dados: { pcr: "16,0 mg/dL", vhs: "48 mm/h", procalcitonina: "0,9 ng/mL" },
    },
    gasometria: {
      interpretacao: "Hipoxemia leve por acometimento pulmonar.",
      dados: { ph: "7,44", paco2: "36 mmHg", pao2: "68 mmHg", hco3: "24 mEq/L", satO2: "93%", lactato: "1,4 mmol/L", be: "+1" },
    },
  },
  "3": {
    hemograma: {
      interpretacao: "Hemograma sem infecção bacteriana, com discreta eosinofilia.",
      dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "8.600/mm³", eosinofilos: "6%", neutrofilos: "55%", linfocitos: "29%" },
    },
    gasometria: {
      interpretacao: "Alcalose respiratória com hipoxemia leve, compatível com crise asmática.",
      dados: { ph: "7,47", paco2: "31 mmHg", pao2: "72 mmHg", hco3: "22 mEq/L", satO2: "94%", lactato: "1,3 mmol/L", be: "-1" },
    },
  },
  "4": { marcadores_cardiacos: { interpretacao: "Marcadores cardíacos sem evidência de necrose miocárdica.", dados: { troponina: "<0,04 ng/mL", ckmb: "2,1 ng/mL", bnp: "62 pg/mL" } } },
  "5": {
    funcao_renal: { interpretacao: "Função renal preservada, sem lesão de órgão-alvo laboratorial no momento.", dados: { ureia: "34 mg/dL", creatinina: "1,0 mg/dL", etfg: "88 mL/min/1,73m²" } },
    urina_tipo_1: { interpretacao: "Urina tipo 1 sem proteinúria significativa.", dados: { ...LABS_BASE_NORMAL.urina_tipo_1!.dados, proteina: "Traços" } },
  },
  "6": {
    hemograma: { interpretacao: "Leucograma discretamente alterado, compatível com pneumonia atípica.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "10.200/mm³", neutrofilos: "68%", linfocitos: "20%", monocitos: "9%" } },
  ...
  "8": {
    funcao_renal: { interpretacao: "Azotemia discreta em contexto congestivo.", dados: { ureia: "52 mg/dL", creatinina: "1,3 mg/dL", etfg: "58 mL/min/1,73m²" } },
    marcadores_cardiacos: { interpretacao: "BNP elevado, compatível com insuficiência cardíaca descompensada.", dados: { troponina: "0,04 ng/mL", ckmb: "2,5 ng/mL", bnp: "980 pg/mL" } },
  },
  "9": {
    hemograma: { interpretacao: "Poliglobulia discreta e leucocitose leve, compatíveis com DPOC exacerbado.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "5,60 mi/mm³", hemoglobina: "16,8 g/dL", hematocrito: "50,5%", leucocitos: "11.200/mm³" } },
    gasometria: { interpretacao: "Retenção de CO2 com hipoxemia.", dados: { ph: "7,33", paco2: "58 mmHg", pao2: "60 mmHg", hco3: "29 mEq/L", satO2: "89%", lactato: "1,5 mmol/L", be: "+3" } },
  },
  "10": {
    gasometria: { interpretacao: "Hipoxemia com alcalose respiratória, compatível com TEP.", dados: { ph: "7,48", paco2: "30 mmHg", pao2: "64 mmHg", hco3: "22 mEq/L", satO2: "91%", lactato: "2,1 mmol/L", be: "-1" } },
  ...
  "11": {
    hemograma: { interpretacao: "Anemia discreta de doença crônica com inflamação persistente.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemoglobina: "11,6 g/dL", hematocrito: "35,0%", leucocitos: "9.400/mm³", monocitos: "11%", plaquetas: "420.000/mm³" } },
  ...
  "12": {
    hemograma: { interpretacao: "Leucopenia e plaquetopenia leves, compatíveis com dengue sem sinais de alarme.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "3.200/mm³", neutrofilos: "42%", linfocitos: "46%", plaquetas: "128.000/mm³", hematocrito: "44,8%" } },
    funcao_hepatica: { interpretacao: "Transaminases discretamente elevadas.", dados: { tgo: "68 U/L", tgp: "52 U/L", fa: "90 U/L", ggt: "36 U/L", bilirrubina_total: "0,9 mg/dL", bilirrubina_direta: "0,2 mg/dL", albumina: "4,0 g/dL" } },
  },
  "13": {
    hemograma: { interpretacao: "Leucocitose com anemia inflamatória discreta.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemoglobina: "10,8 g/dL", hematocrito: "33,2%", leucocitos: "15.600/mm³", neutrofilos: "84%", bastonetes: "6%", linfocitos: "7%", plaquetas: "410.000/mm³" } },
    ...
    urina_tipo_1: { interpretacao: "Micro-hematúria discreta.", dados: { ...LABS_BASE_NORMAL.urina_tipo_1!.dados, sangue_hemoglobina: "+", hemacias: "8-10 p/campo" } },
  },
  "14": { marcadores_cardiacos: { interpretacao: "BNP discretamente elevado por sobrecarga crônica.", dados: { troponina: "<0,04 ng/mL", ckmb: "2,2 ng/mL", bnp: "180 pg/mL" } } },
  "15": { coagulograma: { interpretacao: "Sem alteração de coagulação basal relevante.", dados: { ...LABS_BASE_NORMAL.coagulograma!.dados, d_dimero: "540 ng/mL" } } },
  "16": { marcadores_inflamatorios: { interpretacao: "Marcadores inflamatórios discretamente elevados.", dados: { pcr: "3,2 mg/dL", vhs: "28 mm/h", procalcitonina: "0,08 ng/mL" } } },
  "17": {
    hemograma: { interpretacao: "Anemia microcítica e hipocrômica, compatível com anemia ferropriva.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "3,72 mi/mm³", hemoglobina: "8,9 g/dL", hematocrito: "29,4%", vcm: "68,0 fL", hcm: "22,0 pg", chcm: "31,0 g/dL", rdw: "18,6%", plaquetas: "430.000/mm³" } },
  },
  "38": {
    hemograma: { interpretacao: "Leucopenia e plaquetopenia, compatíveis com dengue clássica.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "3.400/mm³", linfocitos: "48%", plaquetas: "118.000/mm³", hematocrito: "45,2%" } },
    funcao_hepatica: { interpretacao: "Transaminases discretamente elevadas.", dados: { tgo: "74 U/L", tgp: "58 U/L", fa: "92 U/L", ggt: "40 U/L", bilirrubina_total: "0,8 mg/dL", bilirrubina_direta: "0,2 mg/dL", albumina: "4,0 g/dL" } },
  },
  "39": {
    hemograma: { interpretacao: "Hemoconcentração e plaquetopenia importantes, compatíveis com dengue com sinais de alarme.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "2.900/mm³", plaquetas: "62.000/mm³", hematocrito: "49,5%", linfocitos: "52%" } },
    funcao_hepatica: { interpretacao: "Transaminases moderadamente elevadas.", dados: { tgo: "126 U/L", tgp: "98 U/L", fa: "96 U/L", ggt: "42 U/L", bilirrubina_total: "1,1 mg/dL", bilirrubina_direta: "0,3 mg/dL", albumina: "3,6 g/dL" } },
  ...
  "43": {
    hemograma: { interpretacao: "Anemia microcítica e hipocrômica, compatível com anemia ferropriva.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "3,68 mi/mm³", hemoglobina: "8,6 g/dL", hematocrito: "28,8%", vcm: "67,5 fL", hcm: "21,8 pg", chcm: "30,9 g/dL", rdw: "19,1%", plaquetas: "448.000/mm³" } },
  },
  "44": {
    hemograma: { interpretacao: "Anemia hemolítica, com anemia normocítica e padrão regenerativo.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "2,90 mi/mm³", hemoglobina: "8,1 g/dL", hematocrito: "25,8%", vcm: "89,0 fL", hcm: "28,0 pg", chcm: "31,4 g/dL", rdw: "18,4%", leucocitos: "11.300/mm³", plaquetas: "278.000/mm³" } },
    funcao_hepatica: { interpretacao: "Aumento de bilirrubina indireta em contexto hemolítico.", dados: { tgo: "42 U/L", tgp: "30 U/L", fa: "86 U/L", ggt: "28 U/L", bilirrubina_total: "3,2 mg/dL", bilirrubina_direta: "0,4 mg/dL", albumina: "4,2 g/dL" } },
    urina_tipo_1: { interpretacao: "Urina escurecida com hemoglobina positiva.", dados: { ...LABS_BASE_NORMAL.urina_tipo_1!.dados, sangue_hemoglobina: "++", hemacias: "0-2 p/campo", urobilinogenio: "Aumentado" as any } as any },
  },
  "49": {
    hemograma: { interpretacao: "Citopenias com blastos, compatível com leucemia aguda.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "2,80 mi/mm³", hemoglobina: "7,9 g/dL", hematocrito: "24,5%", leucocitos: "32.000/mm³", plaquetas: "48.000/mm³" } },
  },
  "50": { coagulograma: { interpretacao: "Coagulopatia de consumo compatível com CIVD.", dados: { tp: "18,6 s", inr: "1,6", ttpa: "48 s", fibrinogenio: "110 mg/dL", d_dimero: "> 5.000 ng/mL" } } },
  "53": { hemograma: { interpretacao: "Anemia grave microcítica com anisopoquilocitose, compatível com talassemia maior.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemacias: "3,10 mi/mm³", hemoglobina: "6,8 g/dL", hematocrito: "22,6%", vcm: "61,0 fL", hcm: "21,5 pg", chcm: "30,2 g/dL", rdw: "22,0%" } } },
  "55": { hemograma: { interpretacao: "Anemia de doença crônica em contexto renal.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemoglobina: "9,8 g/dL", hematocrito: "30,1%" } }, funcao_renal: { interpretacao: "Disfunção renal crônica.", dados: { ureia: "88 mg/dL", creatinina: "3,1 mg/dL", etfg: "22 mL/min/1,73m²" } } },
  "56": { hemograma: { interpretacao: "Citopenias leves compatíveis com atividade inflamatória autoimune.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, hemoglobina: "10,6 g/dL", leucocitos: "3.800/mm³", plaquetas: "132.000/mm³" } }, marcadores_inflamatorios: { interpretacao: "Inflamação ativa.", dados: { pcr: "2,8 mg/dL", vhs: "54 mm/h", procalcitonina: "0,05 ng/mL" } } },
  "57": { hemograma: { interpretacao: "Linfopenia importante em imunossupressão.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "3.100/mm³", linfocitos: "12%", hemoglobina: "10,9 g/dL" } } },
  "59": { hemograma: { interpretacao: "Leucocitose neutrofílica importante.", dados: { ...LABS_BASE_NORMAL.hemograma!.dados, leucocitos: "21.800/mm³", neutrofilos: "90%", bastonetes: "10%", linfocitos: "4%" } }, marcadores_inflamatorios: { interpretacao: "Marcadores inflamatórios muito elevados.", dados: { pcr: "28,0 mg/dL", vhs: "76 mm/h", procalcitonina: "12,0 ng/mL" } }, gasometria: { interpretacao: "Acidose metabólica láctica compatível com choque séptico.", dados: { ph: "7,28", paco2: "30 mmHg", pao2: "78 mmHg", hco3: "14 mEq/L", satO2: "94%", lactato: "4,8 mmol/L", be: "-11" } }, urina_tipo_1: { interpretacao: "Urina compatível com infecção do trato urinário.", dados: { ...LABS_BASE_NORMAL.urina_tipo_1!.dados, nitrito: "Positivo", esterase_leucocitaria: "++", leucocitos: "> 50 p/campo", bacterias: "Numerosas" } } },
  "60": { gasometria: { interpretacao: "Acidose metabólica com aumento de ânion gap, compatível com cetoacidose.", dados: { ph: "7,18", paco2: "22 mmHg", pao2: "96 mmHg", hco3: "9 mEq/L", satO2: "97%", lactato: "2,2 mmol/L", be: "-17" } }, eletrolitos: { interpretacao: "Distúrbio hidroeletrolítico da cetoacidose diabética.", dados: { sodio: "130 mEq/L", potassio: "5,6 mEq/L", cloro: "96 mEq/L", magnesio: "1,8 mg/dL", calcio: "8,8 mg/dL" } }, funcao_renal: { interpretacao: "Azotemia pré-renal por desidratação.", dados: { ureia: "54 mg/dL", creatinina: "1,6 mg/dL", etfg: "52 mL/min/1,73m²" } } },
};

function buildFonteExamesLaboratoriais(caseId: string): FonteExamesLaboratoriais {
  return {
    ...LABS_BASE_NORMAL,
...
interpretacao: "Elevada - necrose miocárdica confirmada",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("1"),
...
interpretacao: "Compatível com asma aguda",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("3"),
hipoteses_diagnosticas_esperadas: [
{
...
interpretacao: "DAOP confirmada",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("15"),
hipoteses_diagnosticas_esperadas: [
{
...
interpretacao: "Elevado",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("16"),
hipoteses_diagnosticas_esperadas: [
{
...
interpretacao: "Ferro reduzido, TIBC elevada (deficiência)",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("17"),
hipoteses_diagnosticas_esperadas: [
{
...
interpretacao: "IVC com refluxo bidirecional",
    ...
    fonte_exames_laboratoriais: buildFonteExamesLaboratoriais("28"),
hipoteses_diagnosticas_esperadas: [
{
...
// ...casosPediatricos, // Comentado: arquivo legado não está sendo usado
];
