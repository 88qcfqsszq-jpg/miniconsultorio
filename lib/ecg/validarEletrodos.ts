...
// Baseado no posicionamento clássico do ECG
const ECG_ZONES: ECGZone[] = [
  ...
  },
  {
    ...
    x: { min: 35, max: 45 },
    y: { min: 48, max: 56 },
    descricao: '5º espaço intercostal, linha hemiclavicular',
    tolerancia: 8,
  },
  {
    lead: 'V5',
    x: { min: 25, max: 35 },
    y: { min: 48, max: 56 },
    descricao: 'Linha axilar anterior, mesmo nível de V4',
    tolerancia: 8,
  },
  {
    lead: 'V6',
    x: { min: 15, max: 25 },
    y: { min: 48, max: 56 },
    descricao: 'Linha axilar média, mesmo nível de V4',
    tolerancia: 8,
  },
  {
    lead: 'RA',
    x: { min: 75, max: 85 },
    y: { min: 10, max: 25 },
    descricao: 'Membro superior direito (braço/pulso)',
    tolerancia: 10,
  },
  {
    lead: 'LA',
    x: { min: 15, max: 25 },
    y: { min: 10, max: 25 },
    descricao: 'Membro superior esquerdo (braço/pulso)',
    tolerancia: 10,
  },
  {
    lead: 'RL',
    x: { min: 75, max: 85 },
    y: { min: 75, max: 90 },
    descricao: 'Membro inferior direito (tornozelo)',
    tolerancia: 10,
  },
  {
    lead: 'LL',
    x: { min: 15, max: 25 },
    y: { min: 75, max: 90 },
    descricao: 'Membro inferior esquerdo (tornozelo)',
    tolerancia: 10,
  },
]
